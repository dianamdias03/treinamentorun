...
public class GravarMicroCicloTreinos extends framework.Gravar {
    ...
    public void defineTabela() {
        ...
        getTabela().addColuna("i_tipos_modalidades", jsonDados.getJSONObject("tipos_modalidades").optString("i_tipos_modalidades", ""));
        getTabela().addColuna("i_tipos_intensidades", jsonDados.getJSONObject("tipos_intensidades").optString("i_tipos_intensidades", ""));
        getTabela().addColuna("i_tipos_treinos", jsonDados.getJSONObject("tipos_treinos").optString("i_tipos_treinos", ""));
        getTabela().addColuna("i_tipos_distancias", jsonDados.getJSONObject("tipos_distancias").optString("i_tipos_distancias", ""));
        getTabela().addColuna("i_tipos_percursos", jsonDados.getJSONObject("tipos_percursos").optString("i_tipos_percursos", ""));
